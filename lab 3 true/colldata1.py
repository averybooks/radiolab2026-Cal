...
from shared_state import tracking_event, stop_event , results, results_lock, duration, data_array, interval, total_acc, SR
...
def quad_avg_power(spectra_buffer):
    ...
    power   = (np.abs(stacked) ** 2)/50    # |corr01|^2 per accumulation / impedence
