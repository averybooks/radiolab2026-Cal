...
GIT WORKFLOW FOR REFERENCE:
  1. (terminal) cd ("cd ")
  2. Drag and drop project folder into terminal window - should autofill path
  3. enter (now you'rej inside the folder and can run all the git stuff, you can check by typing "ls" to see if the .ipynb file is there.
  4. (Terminal) git pull
  5. Run All cells (or up to what you need to)
  6. Edit
  7. (terminal) git add "file"
  8. (terminal) git commit
  9. (terminal) git push
...
Instructions for Git push and pull:
